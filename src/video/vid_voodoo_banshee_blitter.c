 ...
 *
 *		Emulation of the 3DFX Voodoo Graphics Banshee 
 *		blitter controller.
 *
 * Version:	@(#)vid_voodoo_banshee_blitter.c	1.0.1	2021/09/25
 *
...
update_src_stride(voodoo_t *voodoo)
{
        ...
        switch (voodoo->banshee_blt.srcFormat & SRC_FORMAT_PACKING_MASK) {
                ...
                voodoo->banshee_blt.src_stride_src = voodoo->banshee_blt.src_stride; 
                voodoo->banshee_blt.src_stride_dest = voodoo->banshee_blt.src_stride;
